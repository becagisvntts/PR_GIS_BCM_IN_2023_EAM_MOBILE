  ...
  void handleLogin() async {
    if (loginFormKey.currentState!.validate()) {
      ...
      if (response == true) {
        ...
        Map<String, FormBuilderFieldState> formFields =
            loginFormKey.currentState!.fields;
        for (String key in errors.keys) {
          if (formFields.containsKey(key)) {
            loginFormKey.currentState!.fields[key]!.invalidate(errors[key][0]);
          } else {
            ...
            child: Center(
                child: SingleChildScrollView(
                    child: Column(
                        ...
                        children: [
              AuthHeaderWidget(
                  pageTitle: LocalizationService.translate.user_register),
              FormBuilder(
                  key: loginFormKey,
              ...
              FormControl(
                  child: TextButton(
                      ...
                      child: Text(
                          LocalizationService
                              .translate.user_already_have_account,
