...
class ThemeConfig {
  ...
  static const Color colorPrimary = Color.fromARGB(255, 32, 140, 240);
  static const Color colorSuccess = Color.fromARGB(255, 13, 201, 110);
  static const Color colorDanger = Color.fromARGB(255, 234, 84, 85);
